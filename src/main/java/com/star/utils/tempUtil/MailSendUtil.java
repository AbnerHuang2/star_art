...
/**
 * Created by abner on 2016/12/8.
 */
public class MailSendUtil {
    private final static String host = "smtp.qq.com"; //163的服务器
    private final static String formName = "2011993627@qq.com";//你的邮箱
    private final static String password = "pmcysksodbcsdbce"; //授权码
    private final static String replayAddress = "2011993627@qq.com"; //你的邮箱

    public static void sendHtmlMail(MailInfo info)throws Exception{
        info.setHost(host);
        info.setFormName(formName);
        info.setFormPassword(password);   //邮箱的授权码
    ...
    private static Message getMessage(MailInfo info) throws Exception{
        ...
        //消息的发送者
        message.setFrom(new InternetAddress(p.getProperty("mail.smtp.user"),"Abner"));
